                ...
                <div class="row">
                    <div class="col-xxl-9 offset-xxl-0">
                        <ul class="list-group list-group-numbered mb-3">
                            ...
                            <li class="list-group-item"><span>格順序應如下所示 </span><span class="bg-warning">NID, 姓名, 班級, 類型, 科系ID, 科系, 學院ID, 學院<br></span></li>
                        ...
                        <form>
                            <div class="row">
                                <div class="col" style="text-align: right;">
                                    ...
                                    <br>
                                    <button class="btn btn-primary btn-info shadow-none" type="button"><i class="fa fa-remove"></i>&nbsp;清除</button>
                                    <button class="btn btn-primary shadow-none" type="button">
                                    <i class="fa fa-upload"></i>&nbsp;上傳</button></div>
                            </div>
                        </form>
                    </div>
                    <div class="col">
                        <p class="lead" style="font-size: 20px;">預覽</p><select class="form-select-lg" size="20" multiple="" style="width: 100%">
                            <optgroup label="教授">
                                <option value="12" selected="">T1234567 陳大明</option>
                            </optgroup>
                            <optgroup label="學生">
                                <option value="12" selected="">D1234567 陳小明</option>
                            </optgroup>
                        </select>
                    </div>
                </div>
